...
const WP_BASE           = 'https://oddsbonussen.dk'
// ─────────────────────────────────────────────────────────────────────────────
...
async function main() {
  ...
  for (const wp of posts) {
    ...
    try {
      ...
      const affiliateUrl = str(acf.url) || str(acf.anmeldelse_link) || `https://oddsbonussen.dk/go/${slug}/`
  ...
  console.log(`\n👉 Studio: https://oddsbonussen.vercel.app/studio`)
}
