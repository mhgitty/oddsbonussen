...
async function main() {
  ...
  console.log(`   Source  : https://oddsbonussen.dk`)
  ...
  let page = 1
  while (true) {
    const url = `https://oddsbonussen.dk/wp-json/wp/v2/pages?status=publish&per_page=100&page=${page}&_embed=1`
  ...
  console.log(`\n👉 Review in Studio: https://oddsbonussen.vercel.app/studio`)
}
