    ...
    <footer style={{ borderTop: '1px solid var(--border)', background: 'var(--bg-footer)', marginTop: '80px', padding: '48px 24px 32px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div className="footer-grid">
          ...
          <div>
            <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '12px' }}>Sider</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                ...
                <Link key={href} href={href} style={{ fontSize: '13.5px', color: 'var(--text-muted)', textDecoration: 'none' }}>{label}</Link>
              ))}
            </div>
          </div>
          <div>
            <div style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-faint)', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '12px' }}>Information</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {[
                ['/om-os', 'Om os'],
        ...
        <div style={{ borderTop: '1px solid var(--border)', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
          <p style={{ fontSize: '12.5px', color: 'var(--text-muted)' }}>© {year} Oddsbonussen.dk · Spil ansvarligt · 18+</p>
          <p style={{ fontSize: '12px', color: 'var(--text-faint)' }}>Affiliatelinks kan forekomme · Se vilkår hos bookmaker</p>
        </div>
      </div>
    </footer>
  )
