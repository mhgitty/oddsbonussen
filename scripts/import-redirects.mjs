...
const redirects = [
  { code: 'default',         destination: 'https://oddsbonussen.dk' },
  { code: 'leovegas',        destination: 'https://bandstrack.com/r/leovegas?site=oddsbonussen.dk' },
  ...
  { code: 'mrgreen',         destination: 'https://bandstrack.com/r/mrgreen?site=oddsbonussen.dk' },
  ...
  { code: 'mrvegas',         destination: 'https://bandstrack.com/r/mrvegas?site=oddsbonussen.dk' },
  { code: 'betinia',         destination: 'https://bandstrack.com/r/betinia?site=oddsbonussen.dk' },
  { code: '888casino',       destination: 'https://bandstrack.com/r/888casino?site=oddsbonussen.dk' },
  { code: 'expekt',          destination: 'https://bandstrack.com/r/expekt?site=oddsbonussen.dk' },
  ...
  { code: 'ahtigames',       destination: 'https://site.ahtigames.com/index.php?aname=oddsbonussen.dk&cg=danish' },
  { code: 'campobet',        destination: 'https://bandstrack.com/r/campobet?site=oddsbonussen.dk' },
  { code: 'winlandia',       destination: 'https://site.winlandia.com/index.php?aname=oddsbonussen&zone_id=oddsbonussen' },
  { code: 'playojo',         destination: 'https://bandstrack.com/r/playojo?site=oddsbonussen.dk' },
  { code: 'vindercasino',    destination: 'https://vindercasino.dk/?btag=wildtrigger250&utm_source=oddsbonussen&utm_medium=velkomstgave-wildtrigger250&utm_campaign=wildtrigger250' },
  ...
  { code: 'leovegasmatch',   destination: 'https://bandstrack.com/r/leovegas-match?site=oddsbonussen.dk' },
  ...
  { code: 'leovegaslive',    destination: 'https://bandstrack.com/r/leovegas-live?site=oddsbonussen.dk' },
  { code: 'marathonbet',     destination: 'https://mrthnbet.dk/dc202055b' },
  { code: 'leovegassport',   destination: 'https://bandstrack.com/r/leovegas-sport?site=oddsbonussen.dk' },
  { code: 'expektsport',     destination: 'https://bandstrack.com/r/expekt-sport?site=oddsbonussen.dk' },
  ...
  { code: 'campobetsport',   destination: 'https://bandstrack.com/r/campobet-sport?site=oddsbonussen.dk' },
  { code: 'betiniasport',    destination: 'https://bandstrack.com/r/betinia-sport?site=oddsbonussen.dk' },
  ...
  { code: 'spilleautomaten', destination: 'https://bandstrack.com/r/spilleautomaten?site=oddsbonussen.dk' },
  ...
  { code: '888casinomatch',  destination: 'https://bandstrack.com/r/888casino-match?site=oddsbonussen.dk' },
  { code: 'spildansknu',     destination: 'https://bandstrack.com/r/spildansknu?site=oddsbonussen.dk' },
  { code: 'vbet',            destination: 'https://bandstrack.com/r/vbet?site=oddsbonussen.dk' },
  { code: 'betoro',          destination: 'https://bandstrack.com/r/betoro?site=oddsbonussen.dk' },
  { code: 'betorosport',     destination: 'https://bandstrack.com/r/betoro-sport?site=oddsbonussen.dk' },
  { code: 'vbetsport',       destination: 'https://bandstrack.com/r/vbet-sport?site=oddsbonussen.dk' },
]
